...
<html lang="en">
  ...
  <body>
    ...
    <div class="col-12 col-md-9 mt-5">
        ...
        <div class="card">
            <h5 class="card-header">Editar slider.</h5>
            <div class="card-body">
                <form class="col-md-5" method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        ...
                        <button type="submit" class="btn btn-success ml-3 d-none d-md-block" name="btn_edit_slider">Fazer Upload</button>
                        <button type="submit" class="btn btn-success btn-block mt-3 d-block d-md-none" name="btn_edit_slider">Fazer Upload</button>
                    </div>
                </form>
            </div>
        </div>
