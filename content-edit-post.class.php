                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="title_posts" placeholder="Nome do Produto" required value="<?php echo "$list_edit_posts[title_posts]"; ?>">
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea class="form-control" id="editor" name="description_posts"><?php echo "$list_edit_posts[description_posts]"; ?></textarea>
                            ...
                            <div class="col-md-2">
                                <button type="submit" class="btn btn-warning mt-md-5 btn-block btn-lg" name="btn_edit_posts">Editar</button>
                            </div>
                        </div>
                    </div>    
                </form>
