                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label>Produto</label>
                                <input type="text" class="form-control" name="name_products" placeholder="Nome do Produto" required value="<?php echo "$list_edit_product[name_products]"; ?>">
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <input type="text" class="form-control money" id="inlineFormInputGroup" placeholder="Preço" required name="price_products" value="<?php echo "$list_edit_product[price_products]"; ?>">
                                </div>
                            </div>
                            <div class="form-group col-md-2">
                                <label for="inlineFormInputGroup">Desconto</label>
                                  <div class="input-group mb-2">
                                    <input type="text" class="form-control" id="inlineFormInputGroup" placeholder="Desconto" maxlength="3" name="discount_products" value="<?php echo "$list_edit_product[discount_products]"; ?>">
                                      <div class="input-group-prepend">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea class="form-control" id="editor" name="description_products"><?php echo "$list_edit_product[description_products]"; ?></textarea>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <textarea class="form-control" name="pagseguro_products" required><?php echo "$list_edit_product[pagseguro_products]"; ?></textarea>
                            </div>
                            <div class="col-md-2">
                                <button type="submit" class="btn btn-warning mt-md-5 btn-block btn-lg" name="btn_edit_product">Editar</button>
                            </div>
                        </div>
                    </div>    
                </form>
